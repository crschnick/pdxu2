...
public class AppImages {
    ...
    public static void init() {
        ...
        loadDirectory(AppResources.MAIN_MODULE, "img", true);
    }
        ...
        AppResources.with(module, dir, basePath -> {
            ...
            Files.walkFileTree(basePath, new SimpleFileVisitor<>() {
                ...
                public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
                    ...
                    if (images.containsKey(relativeFileName)) {
                        return FileVisitResult.CONTINUE;
                    }

                    if (loadImages) {
                        images.put(relativeFileName, loadImage(file));
                    }
                    return FileVisitResult.CONTINUE;
                }
            });
    ...
    public static Image image(String file) {
        ...
        TrackEvent.warn("Normal image " + file + " not found");
        return DEFAULT_IMAGE;
    }
