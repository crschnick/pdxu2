...
import com.crschnick.pdxu.core.mode.AppOperationModeSelection;
import com.crschnick.pdxu.issue.ErrorEventFactory;
import com.crschnick.pdxu.issue.LogErrorHandler;
...
public class AppArguments {
    ...
    public static class ModeConverter implements CommandLine.ITypeConverter<AppOperationModeSelection> {

        @Override
        public AppOperationModeSelection convert(String value) {
            return AppOperationModeSelection.get(value);
        }
    }
