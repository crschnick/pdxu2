...
public class DeveloperPageComp extends SimpleComp {
    ...
    protected Region createSimple() {
        ...
        var throwException = new ButtonComp(AppI18n.observable("throwException"), () -> {
            ErrorEventFactory.fromThrowable(new RuntimeException("This is a test exception"))
                    .expected()
                    .handle();
        });
        ...
        var buttons = new VerticalComp(List.of(
                restart,
                throwException,
                throwReportableException,
                throwOmittedException,
